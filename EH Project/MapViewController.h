...
@class CNDataController, MGDetailViewController;

@interface MapViewController : UIViewController <UITableViewDataSource, UITableViewDelegate, MGDetailViewControllerDelegate>
...
@property (weak, nonatomic) IBOutlet UITableView *keyView;
...
@property NSNumber * numberForChoice;
//Controllers
